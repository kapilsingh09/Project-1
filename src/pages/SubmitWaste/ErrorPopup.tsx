      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-white dark:bg-gray-900 border border-red-300 dark:border-red-700 rounded-2xl shadow-2xl p-6"
          >
            {/* Cross button */}
            <button
              type="button"
              ...
              className="absolute right-4 top-4 p-2 rounded-full bg-red-100 hover:bg-red-200 dark:bg-red-900/40 dark:hover:bg-red-900/60 transition-colors focus:outline-none focus:ring-2 focus:ring-red-400"
            >
              <svg
            ...
            <div className="flex items-center gap-3 pr-8">
              ...
              <div>
                <h2 className="text-lg font-bold text-red-700 dark:text-red-400">Form Errors</h2>
            ...
            <ul className="mt-6 space-y-2">
              {errors.map((err, idx) => (
                <li
                  key={idx}
                  className="flex items-start gap-2 text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/30 rounded-md px-3 py-2 shadow-sm"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            {/* Additional context */}
            <div className="mt-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div className="mt-8 flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  onClick={onClose}
                  aria-label="Close error"
                  className="px-5 py-2 rounded-lg bg-gradient-to-r from-red-600 to-red-500 text-white font-semibold shadow hover:from-red-700 hover:to-red-600 transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400"
                >
                  Close
                </button>
              </div>
